...
const TelemetryPanel = () => {
    ...
    const handleOptimize = () => {
        ...
        showToast("Opening training console...", "info", 2000);
    };
    ...
    return (
        <>
            <div className="h-[300px] w-full bg-surface/30 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden flex flex-col">
                <div className="p-4 border-b border-white/10 bg-primary/5 flex justify-between items-center relative z-10">
            ...
            <TrainingModal isOpen={showTraining} onClose={() => setShowTraining(false)} />
        </>
    );
};
